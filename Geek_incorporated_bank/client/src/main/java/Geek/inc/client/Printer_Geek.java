...
/// code van de hogeschool rdam 'gekregen' en daarna aangepast naar onze eigen wensen.

public class Printer_Geek {
    ...
    public static class MyPrintable implements Printable {
        ...
        public int print(Graphics graphics, PageFormat pageFormat, 
            ...
            g2d.drawString("Geek Incorporated Bank", inspringen, fm.getAscent()+ 0);
            g2d.drawString("" + klantnaam, inspringen, fm.getAscent()+ 2 * regelhoogte);
            g2d.drawString("" + rekeningnummer, inspringen, fm.getAscent()+ 3 * regelhoogte);  // aanpassen naar eerste 5 ipv hele rekeningnr!!
            g2d.drawString("Bedrag:", inspringen, fm.getAscent()+ 6 * regelhoogte);
            g2d.drawString("Automaat = Terminal-001", inspringen, fm.getAscent()+ 13 * regelhoogte);
